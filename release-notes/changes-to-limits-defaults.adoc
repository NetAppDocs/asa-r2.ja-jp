...
| クラスターあたりのストレージVM数 | HA ペアごとにサポートされるストレージ仮想マシン (VM) の最大数は 32 から 256 に増加されました。 | ONTAP 9.18.1 


| SnapMirrorアクティブ同期 | SnapMirror アクティブ同期のサポートが、2 ノード クラスタから 4 ノード クラスタに拡張されました。 | ONTAP 9.18.1 
